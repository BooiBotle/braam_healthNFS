  ...
  return (
    <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} style={{ maxWidth: '820px', margin: '0 auto', color: textColor }}>
      ...
      <button
        ...
        style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', background: 'none', border: 'none', color: '#c9a033', fontWeight: 700, fontSize: '0.875rem', cursor: 'pointer', marginBottom: '1.5rem' }}
      >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          ...
          <p style={{ color: mutedText, fontSize: '0.9375rem', marginTop: '0.25rem' }}>
            Configure plan pricing, consultation limits, and member benefits.
          </p>
        </div>
        <button
          onClick={toggleTheme}
